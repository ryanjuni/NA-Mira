    ...
    public telaCadastro() {
        ...
        certificacaoBotao.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (result == JFileChooser.APPROVE_OPTION) {
                    ...
                    JOptionPane.showMessageDialog(cadastroFrame, "Arquivo selecionado: " + selectedFile.getAbsolutePath());
                }
            }
        });
        ...
        cadastrarBotao.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                // Exibe a subtela com os dados cadastrados
                SubTelaSimulacao subTela = new SubTelaSimulacao();
                subTela.simularDados(usuario, email, cpf.isEmpty() ? cnpj : cpf, endereco);

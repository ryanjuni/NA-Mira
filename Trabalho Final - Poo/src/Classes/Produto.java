...
public class Produto {
    ...
    public static ArrayList<String> ProdutoItem() {
        ...
        lista.add(" Produtos :\n");
        lista.add("1 - Rifle AR-15              |R$ (7500.00)\n");
        lista.add("2 - Espingarda Remington 870 |R$(3000.00)\n");
        lista.add("3 - Revolver Smith & Wesson  |R$ (2000.00)\n");
        lista.add("4 - Submetralhadora Uzi      |R$(9000.00)\n");
        lista.add("5 - Rifle de Precisão Barrett M82 |R$(15000.00)\n");
        lista.add("6 - Escopeta Benelli M4 | R$(4500.00)\n");
        lista.add("7 - Pistola Desert Eagle| R$(5000.00)\n");
        lista.add("8 - Fuzil AK-47         | R$(7000.00)\n");
        lista.add("9 - Pistola Beretta 92FS| R$(3500.00)\n");
        lista.add("10 - Pistola Glock      | R$(2500.00)\n");
            ...
            if (opcao.equals("1")) {
                ...
                switch (nome.toLowerCase()) {
                    ...
                    case "escopeta benelli m4":
                        ...
                        break;
                    case "pistola desert eagle":
                        produto = new Produto(7, "Pistola Desert Eagle", 5000.00, quantidade);
                        break;
                    case "fuzil ak-47":
                        produto = new Produto(8, "Fuzil AK-47", 7000.00, quantidade);
                        break;
                    case "pistola beretta 92fs":
                        produto = new Produto(9, "Pistola Beretta 92FS", 3500.00, quantidade);
                        break;
                    case "pistola glock":
                        produto = new Produto(10, "Pistola Glock", 2500.00, quantidade);
                        break;
                    default:
